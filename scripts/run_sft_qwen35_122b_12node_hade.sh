...
LOG_DIR="${LOG_DIR:-${MEG_RUN_DIR}/logs96}"
LOG_FILE="${LOG_FILE:-${LOG_DIR}/sft_full_12node_seq32768_$(date +%Y%m%d_%H%M)_rank${RANK:-0}.log}"
...
OVERRIDES=(
    ...
    # as the layer's bwd finishes). With PP=12 each stage has 4 layers.
