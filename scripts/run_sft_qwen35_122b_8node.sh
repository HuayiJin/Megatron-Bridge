...
#   Use TP=2, PP=4, CP=1, EP=4, DP=8.
#   Math: world_size=64, DP=64/(TP×PP×CP)=64/(2×4×1)=8.
#   EP must ≤ DP → EP=4.
...
#
# Memory note (122B BF16 + Adam, TP=2 PP=4 CP=1 EP=4 DP=8):
#   - Params bf16     ~244 GB total → ~7.6 GB/GPU (distributed across TP×PP×EP)
#   - Grads  bf16     same as params
#   - Adam (m,v) fp32, ZeRO-1 → sharded across DP=8
