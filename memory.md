...
| E. 4-node × 8-GPU full SFT | 🟡 In progress — OOM resolved (EP=4, MTP=0, SEQ=2048, expandable_segments); TRITON_CACHE_DIR NAS race fixed | `scripts/run_sft_qwen35_122b_4node.sh` |
